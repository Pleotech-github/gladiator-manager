...
def client_operation(connect, adr):  # connects link between clients and server
    print(f"New connection: {adr} joined")  # creating a formatting string to add variables to the string text.
...
def client_running():  # Handling of client connections to the server
    server.listen(2)  # server listening for connections
    while True:
